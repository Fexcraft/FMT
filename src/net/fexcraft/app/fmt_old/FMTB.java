package net.fexcraft.app.fmt_old;
...
import net.fexcraft.app.fmt_old.ui.MenuButton;
...
import net.fexcraft.app.fmt_old.ui.editor.TextureEditor;
...
import net.fexcraft.app.fmt_old.utils.*;
...
public class FMTB {
	...
	public void run() throws InterruptedException, IOException, NoSuchMethodException, ScriptException{
		...
		if(Settings.internal_cursor()){
			cursor = new ImageView(new StbBackedLoadableImage("./resources/textures/cursor.png"));
