package net.fexcraft.app.fmt.oui.panels;
...
public class FlipToolsPanel extends EditorPanel {
	...
	public FlipToolsPanel(){
		...
		this.add(new Icon(0, size, 2, xoff, yoff, "./resources/textures/icons/polygon/flip_lr.png", () -> FMT.MODEL.flipPolygons(null, 0)).addTooltip(lang_prefix + ".flip_lr"));
		this.add(new Icon(1, size, 2, xoff, yoff, "./resources/textures/icons/polygon/flip_ud.png", () -> FMT.MODEL.flipPolygons(null, 1)).addTooltip(lang_prefix + ".flip_ud"));
		this.add(new Icon(2, size, 2, xoff, yoff, "./resources/textures/icons/polygon/flip_fb.png", () -> FMT.MODEL.flipPolygons(null, 2)).addTooltip(lang_prefix + ".flip_fb"));
