...
import net.fexcraft.app.fmt.oui.*;
...
public class HelperComponent extends EditorComponent {
	...
	public HelperComponent(Model model){
		...
		add(remove = new Icon(this, 3, "./resources/textures/icons/component/remove.png", () -> PreviewHandler.remove(model)));
		add(edit = new Icon(this, 4, "./resources/textures/icons/component/edit.png", () -> Editor.show("helper_editor")));
