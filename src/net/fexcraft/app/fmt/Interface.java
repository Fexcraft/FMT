...
public class Interface extends Panel {
    ...
    public Interface(int width, int height){
        ...
        widget.getTitle().getStyle().setTextColor(ColorConstants.black());
        ...
        Icon bgIm = new ImageIcon(new BufferedImage("./resources/textures/null.png"));
        bgIm.setSize(new Vector2f(20, 20));
        turnWidVisible.getStyle().getBackground().setIcon(bgIm);
        Icon hbgIm = new ImageIcon(new BufferedImage("./resources/textures/null.png"));
        hbgIm.setSize(new Vector2f(20, 20));
//        turnWidVisible.setHoveredBackgroundIcon(hbgIm);
        Icon pbIm = new ImageIcon(new BufferedImage("./resources/textures/null.png"));
...
//        turnWidVisible.setPressedBackgroundIcon(pbIm);
        ...
        widget2.getTitle().getStyle().setTextColor(ColorConstants.black());
        ...
        widget3.getTitle().getStyle().setTextColor(ColorConstants.black());
        this.add(widget3);
...
//                widget3.setResizable(!widget3.isResizable());
        ...
        textArea.getStyle().setHorizontalAlign(CENTER);
        textArea.getStyle().setVerticalAlign(BOTTOM);
        this.add(textArea);
    ...
    private Widget createImageWrapperWidgetWithImage() {
        ...
        imageView = new ImageView(new BufferedImage("./resources/textures/null.png"));
    ...
    private ToggleButton createToggleButtonWithLongTooltip() {
        ...
        Icon bgImageNormal = new ImageIcon(new BufferedImage("./resources/textures/blank.png"));
