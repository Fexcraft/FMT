...
public class Arrows {
	...
	static {
		...
		new Generator<>(DOWN)
			...
			.set(Values.OFF_Y, 0f)
			.set(Values.RADIUS1, width)
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[4])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		new Generator<>(DOWN)
			.set(Values.TYPE, Generator.Type.CYLINDER)
			.set(Values.OFF_Y, length)
			.set(Values.RADIUS1, hwidth)
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, hlength)
			.set(Values.AXIS_DIR, AxisDir.values()[4])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 0f)
			.make();
		...
		new Generator<>(UP)
			...
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[5])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		new Generator<>(UP)
			.set(Values.TYPE, Generator.Type.CYLINDER)
			.set(Values.OFF_Y, -length - hlength)
			.set(Values.RADIUS1, hwidth)
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, hlength)
			.set(Values.AXIS_DIR, AxisDir.values()[5])
		...
		new Generator<>(LEFT)
			...
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[0])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		...
		new Generator<>(RIGHT)
			...
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[1])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		new Generator<>(RIGHT)
			.set(Values.TYPE, Generator.Type.CYLINDER)
			.set(Values.OFF_Z, -length - hlength)
			.set(Values.RADIUS1, hwidth)
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, hlength)
			.set(Values.AXIS_DIR, AxisDir.values()[1])
		...
		new Generator<>(FRONT)
			...
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[2])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		...
		new Generator<>(BACK)
			...
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, length)
			.set(Values.AXIS_DIR, AxisDir.values()[3])
			.set(Values.SEGMENTS, segs)
			.set(Values.BASE_SCALE, 1f)
			.set(Values.TOP_SCALE, 1f)
			.make();
		new Generator<>(BACK)
			.set(Values.TYPE, Generator.Type.CYLINDER)
			.set(Values.OFF_X, -length - hlength)
			.set(Values.RADIUS1, hwidth)
			.set(Values.RADIUS2, iwidth)
			.set(Values.LENGTH, hlength)
			.set(Values.AXIS_DIR, AxisDir.values()[3])
