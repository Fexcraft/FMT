...
public class OldTextField extends OldElement {
	
	private static final ArrayList<OldTextField> fields = new ArrayList<>();
	...
	public OldTextField(OldElement parent, String id, int width, int x, int y){
	...
	public OldTextField setText(String string, boolean centered){
		this.text = string; this.centered = centered; return this;
	}
	
	public OldTextField setAsNumberfield(float min, float max, boolean centered){
		this.number = true; this.min = min; this.max = max; this.centered = centered; value = 0; return this;
	}
	
	public OldTextField setRenderBackground(boolean bool){
		this.background = bool; return this;
	}
	
	public OldTextField setColor(RGB newcol){
	...
	public static OldTextField getSelected(){
		Optional<OldTextField> sel = fields.stream().filter(pre -> pre.isSelected()).findFirst();
