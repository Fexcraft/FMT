...
public class PivotEditorTab extends EditorTab {
	...
	public void init(Object... objs){
		super.init(objs);
		scrollable.container.add((general = new ETabCom("general")), lang_prefix + "general", 410);
		...
		//
		scrollable.container.add((attrlinks = new ETabCom("attr_links")), lang_prefix + "attr_links", 280);
