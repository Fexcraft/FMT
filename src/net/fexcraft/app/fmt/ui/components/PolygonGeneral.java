...
public class PolygonGeneral extends EditorComponent {
	...
	public PolygonGeneral(){
		...
		this.add(new NumberField(this, F30, HEIGHT + R5, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "pos", "x"));
		this.add(new NumberField(this, F31, HEIGHT + R5, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "pos", "y"));
		this.add(new NumberField(this, F32, HEIGHT + R5, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "pos", "z"));
		this.add(new Label(translate(LANG_PREFIX + id + ".off"), L5, HEIGHT + R6, LW, HEIGHT));
		this.add(new NumberField(this, F30, HEIGHT + R7, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "off", "x"));
		this.add(new NumberField(this, F31, HEIGHT + R7, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "off", "y"));
		this.add(new NumberField(this, F32, HEIGHT + R7, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "off", "z"));
		this.add(new Label(translate(LANG_PREFIX + id + ".rot"), L5, HEIGHT + R8, LW, HEIGHT));
		this.add(new NumberField(this, F30, HEIGHT + R9, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "rot", "x"));
		this.add(new NumberField(this, F31, HEIGHT + R9, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "rot", "y"));
		this.add(new NumberField(this, F32, HEIGHT + R9, 90, HEIGHT).setup(Integer.MIN_VALUE, Integer.MAX_VALUE, true, "rot", "z"));
