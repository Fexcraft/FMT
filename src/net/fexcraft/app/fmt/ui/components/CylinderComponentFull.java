...
public class CylinderComponentFull extends EditorComponent {
	...
	public CylinderComponentFull(){
		...
		this.add(new Label(translate(LANG_PREFIX + id + ".length"), F20, row(1), LW, HEIGHT));
		this.add(new Label(translate(LANG_PREFIX + id + ".direction"), F21, row(0), LW, HEIGHT));
		this.add(new NumberField(this, F20, row(1), F2S, HEIGHT).setup(0.5f, Integer.MAX_VALUE, true, new PolygonValue(PolyVal.LENGTH, ValAxe.N)));
		this.add(new NumberField(this, F21, row(0), F2S, HEIGHT).setup(0, 5, false, new PolygonValue(PolyVal.DIRECTION, ValAxe.N)).index());
		this.add(new Label(translate(LANG_PREFIX + id + ".segments"), F30, row(1), LW, HEIGHT));
		this.add(new Label(translate(LANG_PREFIX + id + ".seg_limit"), F31, row(0), LW, HEIGHT));
		this.add(new Label(translate(LANG_PREFIX + id + ".seg_rot"), F32, row(0), LW, HEIGHT));
		...
		this.add(new Label(translate(LANG_PREFIX + id + ".base_scale"), F20, row(1), LW, HEIGHT));
		this.add(new Label(translate(LANG_PREFIX + id + ".top_scale"), F21, row(0), LW, HEIGHT));
