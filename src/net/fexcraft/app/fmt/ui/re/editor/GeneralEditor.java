...
public class GeneralEditor extends Editor {
	...
	public GeneralEditor(){
		...
		int passed = 24;
		{//attributes
			attributes.getElements().add(new Button(attributes, "text0", "editor:container:title", 290, 20, 4, passed = last(passed, attributes), BLACK).setBackgroundless(true).setText("Polygon Group", false));;
			...
			attributes.getElements().add(new Button(attributes, "text1", "editor:container:title", 290, 20, 4, passed = last(passed, attributes), BLACK).setBackgroundless(true).setText("Polygon Name", false));
			...
			attributes.getElements().add(new Button(attributes, "text2", "editor:container:title", 290, 20, 4, passed = last(passed, attributes), BLACK).setBackgroundless(true).setText("Polygon Type", false));
			...
			attributes.getElements().add(new Button(attributes, "text3", "editor:container:title", 290, 20, 4, passed = last(passed, attributes), BLACK).setBackgroundless(true).setText("Paint to Texture", false));
		...
		{//shape/box
			shape.getElements().add(new Button(shape, "text0", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Measurements / Size", false));
			...
			//
			shape.getElements().add(new Button(shape, "text1", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Position (x/y/z)", false));
			passed += 24; for(int i = 0; i < xyz.length; i++){
			...
			//
			shape.getElements().add(new Button(shape, "text2", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Offset (x/y/z)", false));
			passed += 24; for(int i = 0; i < xyz.length; i++){
			...
			//
			shape.getElements().add(new Button(shape, "text3", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Rotation (x/y/z)", false));
			passed += 24; for(int i = 0; i < xyz.length; i++){
				shape.getElements().add(new TextField(shape, "rot" + xyz[i], "editor:field", 96, 2 + (i * 102), passed).setAsNumberfield(-360, 360, true, true));
			}
			//
			shape.getElements().add(new Button(shape, "text4", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Texture (u/v)", false));
		...
		{//shapebox
			for(int i = 0; i < 8; i++){
				shapebox.getElements().add(new Button(shapebox, "text" + i, "editor:container:title", 290, 20, 4, passed += 30, BLACK).setIcon("blank", 16, ShapeboxWrapper.cornercolors2[i])
		...
		{//cylinder
			cylinder.getElements().add(new Button(cylinder, "text0", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Radius / Length / R2", false));
			...
			//
			cylinder.getElements().add(new Button(cylinder, "text1", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Segments / Direction / SL", false));
			...
			//
			cylinder.getElements().add(new Button(cylinder, "text2", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Base Scale / Top Scale / Top Angle", false));
			...
			//
			cylinder.getElements().add(new Button(cylinder, "text3", "editor:container:title", 290, 20, 4, passed += 30, BLACK).setBackgroundless(true).setText("Top Offset (x/y/z)", false));
			...
			//
			cylinder.getElements().add(new Button(cylinder, "text4", "editor:container:title", 290, 20, 0, passed += 30, BLACK).setBackgroundless(true).setText("Base/Top (on/off)", false));
			cylinder.getElements().add(new TextField.BooleanField(cylinder, "cyl4x", 96, 4, passed += 24));
			cylinder.getElements().add(new TextField.BooleanField(cylinder, "cyl4y", 96, 106, passed));
			cylinder.getElements().add(new Button(cylinder, "text5", "editor:container:title", 290, 20, 0, passed += 30, BLACK).setBackgroundless(true).setText("Outer/Inner (on/off)", false));
			cylinder.getElements().add(new TextField.BooleanField(cylinder, "cyl5x", 96, 4, passed += 24));
			cylinder.getElements().add(new TextField.BooleanField(cylinder, "cyl5y", 96, 106, passed));
			//
			cylinder.getElements().add(new Button(cylinder, "text3", "editor:container:title", 290, 20, 0, passed += 30, BLACK).setBackgroundless(true).setText("Radial Texture (on-off/u/v)", false));
			cylinder.getElements().add(new TextField.BooleanField(cylinder, "cyl6x", 96, 4, passed += 24));
