...
public class ModelTree extends Element {
	...
	private int scroll, trheight;
	private TurboList[] trlist;

	public ModelTree(){
		super(null, "modeltree"); this.width = 308; z = -50;
	...
	private RGB color(boolean visible, boolean selected){
	...
	public void toggleVisibility(){
		this.visible = !this.visible; this.scroll = 0;
	}

	public void setVisible(){
		this.visible = true; this.scroll = 0;
	}
