...
public enum PolyVal {
	...
	/* Cylinder */
	RADIUS_O, RADIUS_I, LENGTH, SEGMENTS, SEG_LIMIT, DIRECTION, BASE_SCALE, TOP_SCALE, TOP_OFF, TOP_ROT, RADIAL, SEG_WIDTH, SEG_HEIGHT, SEG_OFF,

	/* Sphere */
	CIRCLES, CIR_LIMIT, CIR_OFF,
	...
	/* Curve */
	CUR_AMOUNT, CUR_PLANES, CUR_POINTS, CUR_ACTIVE, CUR_ACTIVE_POINT, CUR_ACTIVE_PLANE, PLANE_ROT, PLANE_LOC, PLANE_LOC_LIT, CUR_LENGTH,

	/* Object */
	VERTICES, OBJ_VERT_ACTIVE, OBJ_VERT_OFFSET, OBJ_FACES, OBJ_FACE_ACTIVE, OBJ_FACE_TRIANGLE, OBJ_FACE_VERTEX, OBJ_FACE_UV
    ...
    public static class PolygonValue {
		...
		public PolygonValue(PolyVal val){
			this.val = val;
			axe = ValAxe.N;
		}
