...
public class TexrectWrapperB extends ShapeboxWrapper {
	...
	protected ModelRendererTurbo newMRT(){
		return new ModelRendererTurbo(null, textureX, textureY, compound.tx(getTurboList()), compound.ty(getTurboList())).addTexRect(off.xCoord, off.yCoord, off.zCoord, size.xCoord, size.yCoord, size.zCoord, 0, cor0.xCoord, cor0.yCoord, cor0.zCoord, cor1.xCoord, cor1.yCoord, cor1.zCoord, cor2.xCoord, cor2.yCoord, cor2.zCoord, cor3.xCoord, cor3.yCoord, cor3.zCoord, cor4.xCoord, cor4.yCoord, cor4.zCoord, cor5.xCoord, cor5.yCoord, cor5.zCoord, cor6.xCoord, cor6.yCoord, cor6.zCoord, cor7.xCoord, cor7.yCoord, cor7.zCoord, texcor).setRotationPoint(pos.xCoord, pos.yCoord, pos.zCoord).setRotationAngle(rot.xCoord, rot.yCoord, rot.zCoord);
	}
	...
	public PolygonWrapper convertTo(ShapeType type){
		...
		switch(type){
			case TEXRECT_A:
				wrapper = new TexrectWrapperA(compound);
				break;
			case SHAPEBOX:
